package nickyhuynh.helloworld.network;
...
public class JsonObjectRequestCustomHeaderDelete extends JsonObjectRequest {
    Context context;
	public JsonObjectRequestCustomHeaderDelete(Context context, int method, String url,
