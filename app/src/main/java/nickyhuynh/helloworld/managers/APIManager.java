...
import nickyhuynh.helloworld.network.JsonObjectRequestCustomHeader;
import nickyhuynh.helloworld.network.JsonObjectRequestCustomHeaderDelete;
import nickyhuynh.helloworld.network.JsonObjectRequestCustomHeaderPatch;
import nickyhuynh.helloworld.network.VolleySingleton;
...
//        }
        ...
        switch (method) {
            case Request.Method.GET:
                makeAPICallGet(url, bodyParams, context, listener);
                break;
